...
namespace PojazdyLab
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Vehicle> pojazdy = new List<Vehicle>() { lotnia, samochod, rower, motocykl, helikopter, szybowiec, kajak, motorowka, podwodna, amfibia };
            ...
            Console.WriteLine($"\nPojazdy w środowisku lądowym, od aktualnie najszybciej poruszającego się do najwolniejszego:");

            pojazdy.Reverse();

            List<Vehicle> pojazdySrodowiskoLadowe = new List<Vehicle>();

            foreach (var pojazd in pojazdy)
            {
                if (pojazd.ToString().Contains("Aktualne środowisko: Lądowe")) Console.WriteLine("\n" + pojazd);
            }
