...
namespace PojazdyLab
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(rower.CurrentSpeed);
            //Console.WriteLine(Vehicle.ConvertUnits(rower.Unit, PojazdyLib.Enums.SpeedUnit.metersPerSecond, rower.currentSpeed));
            //Console.WriteLine(Vehicle.ConvertUnits(rower.Unit, PojazdyLib.Enums.SpeedUnit.nauticalMilePerHour, rower.currentSpeed));

            //Console.WriteLine(helikopter.CurrentSpeed);
            //Console.WriteLine(Vehicle.ConvertUnits(helikopter.Unit, PojazdyLib.Enums.SpeedUnit.kilometersPerHour, helikopter.currentSpeed));
            //Console.WriteLine(Vehicle.ConvertUnits(helikopter.Unit, PojazdyLib.Enums.SpeedUnit.nauticalMilePerHour, helikopter.currentSpeed));
